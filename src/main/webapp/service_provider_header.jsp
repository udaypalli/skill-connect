...
<img src="<%= profileImage %>" class="profile-img" id="profileIcon">
    ...
    <div class="sidebar" id="sidebarMenu">
        ...
        <a href="service_provider_dashboard.jsp">Dashboard</a>
        <a href="service_provider_edit_profile.jsp">Edit Profile</a>
        <a href="service_provider_tasks.jsp">My Tasks</a>
        <a href="service_provider_business.jsp">My Business</a>
        <a href="service_provider_notifications.jsp">Notifications</a>
        <a href="service_provider_payment.jsp">Payments</a>
        <a href="service_provider_promotions.jsp">Promotions</a>
        <a href="service_provider_customer_support.jsp">Customer Support</a>
